    ...
    return (
        ...
        <div className='container' style={{marginTop:'50px'}}>
            <div className='row pt-3 mt-5'>
                ...
                <a href='https://drive.google.com/file/d/1KnuaGtcchvr8lAtHH8Z6E-NepBs3Xsiu/view?usp=sharing' target='blank'><button className='btn btn-primary py-3 ' id='homebtn'  style={{width:"150px"}}>Resume</button></a>
                </div>
                <div className='mt-4'>
