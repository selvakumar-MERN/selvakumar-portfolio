                    ...
                    <div class="card h-100" >
                             <img class="card-img-top" src='project5.PNG' height={"300px"} width={"300px"} alt="project5"/>
                                <div class="card-body">
                                    ...
                                    ,Users can able to add product to the cart and can check out the product with an intergrated razor pay payment system. Search bar allows to search the product category wise. Also provided with Filter by price, sort by rating and sorting based on product price,popularity.
